...
spline1 = schumaker_spline(x1, y1, return_type='sympy')
print("Schumaker Spline (Example 1):")
print(spline1)
print("-" * 30)

# Plot only the data and the Shumaker spline with a clean label
p1 = plot((spline1, (x_sym, x1.min(), x1.max()), "Schumaker Spline"), # Explicit label
...
knots2, _ = schumaker_spline(x1, y1, return_type='coeffs') # Get knots
...
p2 = plot((spline2, (x_sym, x1.min(), x1.max()), "Schumaker Spline"), # Explicit label
...
knots3, _ = schumaker_spline(x3, y3, return_type='coeffs')
spline_schumaker3 = schumaker_spline(x3, y3, return_type='sympy')
print("Schumaker Spline (Example 3):")
print(spline_schumaker3)
print("-" * 30)
...
p3 = plot((spline_schumaker3, (x_sym, x3.min(), x3.max()), 'Schumaker'),
